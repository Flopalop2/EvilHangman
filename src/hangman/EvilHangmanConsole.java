...
public class EvilHangmanConsole {

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        System.out.print("Please input the dictionary txt name: ");
        String dictionaryFileName = scanner.next();

        System.out.print("Please input length of word: ");
        int wordLength = scanner.nextInt();

        System.out.print("Please input max number of guesses: ");
