...
public class HangmanTest {
    ...
    void testEmptyFileLoad(){
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> studentGame.startGame(new File(EMPTY_DICTIONARY), 4), "Failed to throw hangman.EmptyDictionaryException.");
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> studentGame.startGame(new File(DICTIONARY), 1), "Failed to throw hangman.EmptyDictionaryException.");
        Assertions.assertThrows(EmptyDictionaryException.class, ()-> studentGame.startGame(new File(SMALL_DICTIONARY), 15), "Failed to throw hangman.EmptyDictionaryException.");
    }
    ...
    void testWordLength0(){
        try{
            Assertions.assertThrows(EmptyDictionaryException.class, ()-> studentGame.startGame(new File(DICTIONARY), 0), "Failed to throw hangman.EmptyDictionaryException.");
        }
        catch(Throwable e){
    ...
    void testGuessAlreadyMade(){
        ...
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> studentGame.makeGuess('a'), "Failed to throw hangman.GuessAlreadyMadeException.");
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> studentGame.makeGuess('A'), "Failed to throw hangman.GuessAlreadyMadeException with uppercase letter.");
        ...
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> studentGame.makeGuess('E'), "Failed to throw hangman.GuessAlreadyMadeException with uppercase letter.");
        Assertions.assertThrows(GuessAlreadyMadeException.class, ()-> studentGame.makeGuess('a'), "Failed to throw hangman.GuessAlreadyMadeException with previously guessed letter.");
    }
